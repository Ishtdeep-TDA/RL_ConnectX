...
class MCTS_Agent():
    ...
    def __init__(self, game, policy, args):
        self.game = game
#         self.nnet = nnet
        self.policy = RandomPolicy()  # Agent (could be a NN or something else)
        self.args = args
        self.mcts = MCTS(self.game, self.policy, self.args)
...
#       reset the environment
        ...
        while True: 
            ...
            # Reset the tree
            self.mcts = MCTS(game_copy, self.policy, self.args)
    ...
    def test_policy(self,game,opt_player):
        '''
        Once the agent has been trained, We call this function to play the move in the actual game
        
        Here game represents the actual board
        '''
